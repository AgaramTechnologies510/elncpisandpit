...
public interface ElnmaterialInventoryRepository extends JpaRepository<ElnmaterialInventory, Integer>{
	...
	List<ElnmaterialInventory> findByMaterialAndNtransactionstatusAndIsresuableOrderByNmaterialinventorycodeDesc(
			Elnmaterial elnmaterial, int i, boolean b);

	ElnmaterialInventory findByNmaterialinventorycodeAndNtransactionstatusAndIsresuable(Integer nmaterialinventorycode,
			int i, boolean b);

	ElnmaterialInventory findByNmaterialinventorycodeAndNtransactionstatusAndIsresuableAndIsresuablereached(
			Integer nmaterialinventorycode, int i, boolean b, boolean c);

	List<ElnmaterialInventory> findByMaterialAndNtransactionstatusAndIsresuableAndIsresuablereachedOrderByNmaterialinventorycodeDesc(
			Elnmaterial objMaterial, int i, boolean b, boolean c);

	List<ElnmaterialInventory> findByMaterialInAndNtransactionstatusAndNstatusAndIsresuableOrderByNmaterialinventorycodeDesc(
			List<Elnmaterial> material, int i, int j, boolean b);

	List<ElnmaterialInventory> findByMaterialInAndNtransactionstatusAndNstatusAndIsresuableAndIsresuablereachedOrderByNmaterialinventorycodeDesc(
			List<Elnmaterial> material, int i, int j, boolean b, boolean c);
}