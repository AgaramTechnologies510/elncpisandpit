...
public class ElnmaterialInventory {
	...
	private Boolean isresuablereached;
	
	private Integer reusablecount;
	private Integer reusableqty;

	public Boolean getIsresuablereached() {
		return isresuablereached;
	}

	public void setIsresuablereached(Boolean isresuablereached) {
		this.isresuablereached = isresuablereached;
	}

	public Boolean getIsresuable() {
		return isresuable;
	}

	public void setIsresuable(Boolean isresuable) {
	...
	public Integer getReusableqty() {
		return reusableqty;
	}

	public void setReusableqty(Integer reusableqty) {
