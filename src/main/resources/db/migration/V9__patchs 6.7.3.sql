...
ALTER TABLE IF Exists elnmaterial ADD COLUMN IF NOT EXISTS reusableqty Integer;

ALTER TABLE IF Exists elnmaterialinventory ADD COLUMN IF NOT EXISTS isresuable boolean;
ALTER TABLE IF Exists elnmaterialinventory ADD COLUMN IF NOT EXISTS isresuablereached boolean;
ALTER TABLE IF Exists elnmaterialinventory ADD COLUMN IF NOT EXISTS reusablecount Integer;
ALTER TABLE IF Exists elnmaterialinventory ADD COLUMN IF NOT EXISTS reusableqty Integer;
